...
| A43 | 3D-Strategien — **Waterline** ✅ (`cam/waterline.py` mit eigener Marching-Squares-Implementation + 8 Tests). Circular/Radial/Offset/Pencil-Trace folgen in spaeteren Stufen. | [#36](https://github.com/MadGapun/CAMWOSA/issues/36) | [Operation-Relief](Operation-Relief.md) | 🟨 |
...
| A45 | Spezial-Operationen — **E3 Dogbone-Slots** ✅ (`cam/dogbone.py` mit DOGBONE+T_BONE Stilen, Innenecken-Erkennung, 11 Tests). **E8 Lithophane** ✅ (`stl/lithophane.py` mit min/max-Dicke, 5 Tests). Auto-Inlay/V-Carve-Inlay/Thread-Milling/Chamfering/Drag-Engraving-Op/Rest-Machining folgen in spaeteren Stufen. | [#39](https://github.com/MadGapun/CAMWOSA/issues/39) | [Spezial-Operationen](Spezial-Operationen.md) | 🟨 |
...
| A47 | Sicherheit/Workholding — **Spannmittel-Modell** ✅ (`db/spannmittel.py` mit 8 Typen, Sicherheitszonen rund/box, Z-Hoehe, `punkt_in_sperrzone()` + `pruefe_toolpath_gegen_spannmittel()`, 8 Tests). Collet-Check via `free_length_mm` (A46 fertig). Reference-Planes/Z-Grid-Diagnose/Schaft-Visualisierung in spaeteren Stufen. | [#42](https://github.com/MadGapun/CAMWOSA/issues/42) | [Sicherheits-Checks](Sicherheits-Checks.md) | 🟨 |

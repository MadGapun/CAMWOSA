...
| A41 | Werkzeug-Typen-Doku ueberarbeiten: pro Typ (11 inkl. BALLNOSE_V_BIT) Wiki-Eintrag mit Skizze + Anwendung + Parameter-Erklaerung. Glossar erweitern (Plunge, Eckradius, Fischschwanz etc.). Modell-Audit: pruefen ob alle Typen die noetigen Pflichtfelder im Pydantic-Model haben (z.B. Bohrer-Spitzenwinkel, Gravierstichel-Spitze-Breite). | [#32](https://github.com/MadGapun/CAMWOSA/issues/32) | [Werkzeug-Typen](Werkzeug-Typen.md) | ⬜ |
...
| A43 | 3D-Strategien fuer Geometry/Relief — Circular (konzentrisch), Radial (Strahlen), Offset/Freeform (folgt Geometrie-Form), Waterline/Contour (horizontale Z-Schnitte), Pencil-Trace (Innenecken). Plus Helix als sauberes Detail-Setting fuer Rotary. Stufen B1-B4. | [#36](https://github.com/MadGapun/CAMWOSA/issues/36) | [Operation-Relief](Operation-Relief.md) | ⬜ |
...
| A45 | Spezial-Operationen — Auto-Inlay (Maennlich+Weiblich mit Toleranz), V-Carve-Inlay, Dogbone-Slots (Eckenausgleich fuer Holzverbindungen), Thread-Milling (Gewinde fraesen), Chamfering (Fasen), Drag-Engraving (Diamant ohne Spindel-Drehung), Rest-Machining (nur Restmaterial), Lithophane-Workflow. Stufen E1-E8. | [#39](https://github.com/MadGapun/CAMWOSA/issues/39) | [Spezial-Operationen](Spezial-Operationen.md) | ⬜ |
| A46 | Cutter-Modellierung erweitern — Multiple-Diameter mit Slope-Angle (konischer Schaft-Flute-Uebergang), Free-Length (Collet-Distanz), Auto-Set-Speeds bei Werkzeug-Wahl, Drag-Engraver-Typ, Special-Cutters (Disk/Saege/Hot-Wire/Laser). | [#40](https://github.com/MadGapun/CAMWOSA/issues/40) | [Werkzeug-Bibliothek](Werkzeug-Bibliothek.md) | ⬜ |
| A47 | Sicherheit/Workholding — Collet-Collision-Check (free_length, Visualisierung), Spannmittel-Modell mit Sicherheitszonen (Zwingen/Vakuum/Spannfutter), Reference-Planes/Datum-Setting fuer Wiederaufspannen, Z-Grid als Diagnose-Tool, STL-Backfaces-Diagnose, Werkzeug-Schaft-Visualisierung in Toolpath-Preview, Stepover-vs-Werkzeug-Typ-Warnungen. Stufen H1-H8. | [#42](https://github.com/MadGapun/CAMWOSA/issues/42) | [Sicherheits-Checks](Sicherheits-Checks.md) | ⬜ |
| A48 | Projekt-Modell: Single-Project-Constraint + Dependency-Graph + Dirty/Broken-Status pro Operation + Run-Lock (G-Code-Export blockiert wenn inkonsistent) + Change-Propagation (Geometrie/Werkzeug/Material aendert -> abhaengige Ops markieren). Markus' Regel: „Im Zweifel laeuft das Programm nicht". Voraussetzung fuer D31 (Geometrie-Operation-Verknuepfung). | [#43](https://github.com/MadGapun/CAMWOSA/issues/43) | [Projekt-Format](Projekt-Format.md) · [Workflow-Modul](Workflow-Modul.md) | ⬜ |
...
| D36 | Hilfe-System (HOECHSTE PRIO Anfaenger-Tauglichkeit) — Hover-Help auf JEDEM Feld (200+ Eingaben), Inline-Grafiken pro Strategie (20-30 Icons), grosse annotierte Skizzen in Editoren, Field-Wertbereich-Validierung mit Hinweisen, Glossar 60+ Begriffe FachTooltip-Pattern an allen Vorkommen, First-Run-Wizard mit Erklaer-Texten, Built-in-Quick-Start-Tour + Sample-Files. | [#41](https://github.com/MadGapun/CAMWOSA/issues/41) | [Tooltip-System](Tooltip-System.md) · [First-Run-Wizard](First-Run-Wizard.md) | ⬜ |
